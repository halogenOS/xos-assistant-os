{
  inputs = {
    ...
    assistant-src = {
      url = "git+https://github.com/halogenOS/xos-assistant?ref=main&rev=fb37626f57765a3833e886f07a387208f35da4b7";
      flake = false;
    };
    ...
    agent-ledger-src = {
      url = "git+https://github.com/xdevs23/ronna-core?ref=main&rev=b0cfb969f365d5558a1aebd9917e3b68bb87427c";
      flake = false;
    };
  };
