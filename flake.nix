{
  inputs = {
    ...
    assistant-src = {
      url = "git+https://github.com/halogenOS/xos-assistant?ref=main&rev=d83ddcd4dd3dfa4e2bacef31cf4b8dde1933600d";
      flake = false;
    };
    ...
    agent-ledger-src = {
      url = "git+https://github.com/xdevs23/ronna-core?ref=main&rev=2a8e89527777e2db963c7f2ffddaf769aa548b1a";
      flake = false;
    };
  };
