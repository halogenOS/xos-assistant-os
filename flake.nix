{
  inputs = {
    ...
    assistant-src = {
      url = "git+https://github.com/halogenOS/xos-assistant?ref=main&rev=1162cabbc2669e03e16c3a8829309576fa7a0126";
      flake = false;
    };
    ...
    agent-ledger-src = {
      url = "git+https://github.com/xdevs23/ronna-core?ref=main&rev=bfcc6c7804b257c443d035b04ae03d759eccc19b";
      flake = false;
    };
  };
