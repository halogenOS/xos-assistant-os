{
  inputs = {
    ...
    assistant-src = {
      url = "git+https://github.com/halogenOS/xos-assistant?ref=main&rev=5436fde95c9309c4f9b1e902690d1dba4e181d41";
      flake = false;
    };
    ...
    agent-ledger-src = {
      url = "git+https://github.com/xdevs23/ronna-core?ref=main&rev=0b7cdd82e03a656342aa1a36c6fcd55172375bac";
      flake = false;
    };
  };
