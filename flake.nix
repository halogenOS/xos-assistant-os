{
  inputs = {
    ...
    assistant-src = {
      url = "git+https://github.com/halogenOS/xos-assistant?ref=main&rev=9ff182e10ae0cd7dfed7f39dca33f5d7d18f240f";
      flake = false;
    };
    ...
    agent-ledger-src = {
      url = "git+https://github.com/xdevs23/ronna-core?ref=main&rev=b7c0c45ac673bf19d6464d3bb09d993e68c22477";
      flake = false;
    };
  };
