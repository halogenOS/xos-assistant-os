{
  inputs = {
    ...
    assistant-src = {
      url = "git+https://github.com/halogenOS/xos-assistant?ref=main&rev=4f0f281639720129fc6378455c267f7c97a78e87";
      flake = false;
    };
    ...
    agent-ledger-src = {
      url = "git+https://github.com/xdevs23/ronna-core?ref=main&rev=738bfe06b5d1e29366d86c4ea39819fd1bb8d53d";
      flake = false;
    };
  };
